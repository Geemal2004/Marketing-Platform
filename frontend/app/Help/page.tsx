                    ...
                    <div className="flex gap-6 group">
                        ...
                        <div className="pb-12">
                            ...
                            <ul className="space-y-3 text-slate-600">
                                ...
                                <li className="flex gap-2">
                                    <span className="text-blue-500 font-bold">•</span>
                                    <span>Choose a <b>creative type</b> (video, print, banner, OOH, radio, streaming audio, email, blog, or <b>Custom</b> for free-form ideas/ideologies) and upload the file — or paste text for email/blog/custom. Gemini (or text extraction) turns it into a factual simulation brief for the agents.</span>
                                </li>
                                <li className="flex gap-2">
                                    <span className="text-blue-500 font-bold">•</span>
